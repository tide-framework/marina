...
smalltalk.addClass('MRAbstractLoginWidget', globals.MRFrameWidget, ['errorDiv', 'onLoginBlock', 'presenter'], 'Marina-Widgets');
smalltalk.addMethod(
smalltalk.method({
selector: "onLogin:",
protocol: 'actions',
...
smalltalk.addClass('MRMozillaPersonaLoginWidget', globals.MRAbstractLoginWidget, [], 'Marina-Widgets');
smalltalk.addMethod(
smalltalk.method({
selector: "login:",
protocol: 'actions',
